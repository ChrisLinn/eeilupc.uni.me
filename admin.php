				...
				<article id="post-0" class="post no-results not-found">
					...
					<div class="entry-content" >
						<!--------------------------------------------------内容是在这添加么-------------------------------------------------------------------------------------------------------------------------------->
							...
							<select name="Opri"><option value="1">
							普通用户</option><option value="2">
							创新实验室成员</option><option value="5">
							管理员</option></select>
							...
							<h4>要查询的日期:</h4>
							格式如：“20120128”<br/>
							<input style="width:8%" type="text" name="date" /><input value="选择" type="submit" />
							</form>
							<br/>
							你的身份是：
							<?php
							...
							?>
							<br/><br/><br/>
							<a style="position: relative;right: 45px" href="/reborn.php">修改个人信息</a>
							<a style="position: relative;left: 40px" href="/logout.php">注销</a>
							<br/>			
					</div><!-- .entry-content -->
				</article><!-- #post-0 -->
