...
M.addEventFns({
   ...
   <div class="right-wrap">
    ...
    <?php if($sidebar_following_list['data']){ ?>
        <div class="attention mb20 clearfix border-b">
                    ...
                    <div id="col5" class="st-index-main">
                        <div class="extend-foot">
                            <div class="tab-menu clearfix">                        
                                <ul>
                                  <li class="current"><span><a href="<?php echo U('public/Profile/index',array('type'=>$type,'feed_type'=>'','uid'=>$uid));?>">微博</a></span></li>
                                  <?php if($mid==$uid || CheckPermission('core_normal','read_data')){ ?><li><span><a href="<?php echo U('public/Profile/data',array('uid'=>$uid));?>">资料</a></span></li><?php } ?>
                                </ul>
                            </div>
