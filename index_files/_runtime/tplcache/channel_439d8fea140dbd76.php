...
<div id="page-wrap">
  <div id="main-wrap">
    <div class="mb20 boxShadow clearfix channel-box">
      <div class="app-title clearfix">
        <div class="right">
          <a href="<?php echo U('channel/Index/index', array('cid'=>$cid, 'tpl'=>'load'));?>" class="mr10 <?php if(($tpl)  !=  "list"): ?>current<?php endif; ?>"><i class="ico-feed mr5"></i>瀑布流</a>
          <a href="<?php echo U('channel/Index/index', array('cid'=>$cid, 'tpl'=>'list'));?>" <?php if(($tpl)  ==  "list"): ?>class="current"<?php endif; ?>><i class="ico-list mr5"></i>列表</a>
        </div>
        <h4><img src="__APP__/image/ico-channel.gif" />频道</h4>
      </div>
      <?php echo W('TopMenu', array('cid'=>$cid, 'title'=>$_title, 'channelCategory'=>$channelCategory));?>
    </div>
    <!-- 内容渲染 -->
    <?php if($tpl == 'load'): ?>
    <?php echo W('Content', array('tpl'=>$tpl,'cid'=>$cid,'channelCategory'=>$channelCategory));?>
    <?php elseif($tpl == 'list'): ?>
    <div id="col8" class="st-section boxShadow">
      <div id="col3" class="st-index-right">
        <div class="right-wrap">
          <div class="box channel-tab-menu clearfix border-b">
            <dl>
              <dt>
          ...
          <?php echo W('TopList', array('cid'=>$cid));?>
        </div>
      </div>
      <div id="col5" class="st-index-main">
        <?php echo W('Content', array('tpl'=>$tpl,'cid'=>$cid));?>
      </div>
    </div>
    <?php endif; ?>
  </div>
...
$(function() {
  // 浮动菜单
  channel.setDropBox('channel_selector', 'channel_category_btn');
  // Fix导航
  channel.setNavigation('channel_nav');
});
</script>
