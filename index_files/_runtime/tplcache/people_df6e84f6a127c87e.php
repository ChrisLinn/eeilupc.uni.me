  ...
  <div id="main-wrap">
    <div class="boxShadow">
          ...
          <div class="app-tab-menu">
            <ul>
              <?php if(in_array('tag',$findPeopleConfig)){ ?>
                <li>
                  <a <?php if(($type)  ==  "tag"): ?>class="current"<?php endif; ?> href="<?php echo U('people/Index/index', array('type'=>'tag'));?>">按标签<?php if(($type)  ==  "tag"): ?><span class="triangle"></span><?php endif; ?></a>
                </li>
              <?php } ?>
              <?php if(in_array('area',$findPeopleConfig)){ ?>
                <li>
                  <?php if($findPeopleConfig[0] != 'area'){ ?><i class="line"></i><?php } ?>
                  <a <?php if(($type)  ==  "area"): ?>class="current"<?php endif; ?> href="<?php echo U('people/Index/index', array('type'=>'area'));?>">按地区<?php if(($type)  ==  "area"): ?><span class="triangle"></span><?php endif; ?></a>
                </li>
              <?php } ?>
              <?php if(in_array('verify',$findPeopleConfig)){ ?>
                <li>
                  <?php if($findPeopleConfig[0] != 'verify'){ ?><i class="line"></i><?php } ?>
                  <a <?php if(($type)  ==  "verify"): ?>class="current"<?php endif; ?> href="<?php echo U('people/Index/index', array('type'=>'verify'));?>">认证用户<?php if(($type)  ==  "verify"): ?><span class="triangle"></span><?php endif; ?></a>
                </li>
              <?php } ?>
              <?php if(in_array('official',$findPeopleConfig)){ ?>
                <li>
                  <?php if($findPeopleConfig[0] != 'official'){ ?><i class="line"></i><?php } ?>
                  <a <?php if(($type)  ==  "official"): ?>class="current"<?php endif; ?> href="<?php echo U('people/Index/index', array('type'=>'official'));?>">官方推荐<?php if(($type)  ==  "official"): ?><span class="triangle"></span><?php endif; ?></a>
                </li>
              <?php } ?>
            </ul>
          </div>

          <div class="search-input" style="z-index:99;float:right;width:240px;">
            <form id="search_people" action="<?php echo U('public/Search/index');?>" method="GET">
                <input name="app" value="public" type="hidden" />
                <input name="mod" value="Search" type="hidden" />
                <input name="a" value="public" id='search_a' type="hidden"/>
                <input name="t" value="1" id='search_t' type="hidden"/>
                <input id="searchpeople_input" class="s-txt left"  type="text" value="<?php if(!empty($searchkey)){ ?><?php echo ($searchkey); ?><?php }else{ ?>请输入昵称<?php } ?>" onfocus="this.value=''" onblur="if(this.value=='') this.value='请输入昵称';" name="k">
                <a href="javascript:void(0)" class="btn-search" onclick="if(getLength($('#searchpeople_input').val()) && $('#searchpeople_input').val()!=='请输入昵称'){ $('#search_people').submit(); return false;}"><span>搜索</span></a>
            </form>
          </div>
      </div>
        </div>
      ...
      <div id="col" class="extend clearfix">
        <div id="col9" class="st-index-right">
          ...
          <div id="col0">
            <?php echo W('Menu', array('cid'=>$cid,'sex'=>$sex,'area'=>$area,'verify'=>$verify,'type'=>$type));?>
          </div>
      </div>
    </div>
  </div>
