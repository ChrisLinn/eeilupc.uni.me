	...
	<div class="reg-wrap">
	   <div class="reg-main">
		<div class="article boxShadow">
			<div class="title"><?php echo L('PUBLIC_RESET_PASSWORD');?></div>
			<dl class="search-find">
				<dt>
				<form id="find_password_form" method="POST" action="<?php echo U('public/Passport/doFindPasswordByEmail');?>">
					...
					<a href="javascript:;" onclick="$('#find_password_form').submit();" class="btn-green-big"><span><?php echo L('PUBLIC_SEND');?></span></a>
				</form>
				</dt>
	            <dd><?php echo L('PUBLIC_PASSWORD_EMAIL_INPUT');?></dd>
	            <dd><?php echo L('PUBLIC_PASSWORD_EMAIL_TIPS');?></dd>
			</dl>
		</div>
	  </div>
	</div>
