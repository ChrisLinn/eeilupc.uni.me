...
// 		$this->opt['position'] = array('0'=>L('PUBLIC_HEAD_NAVIGATION'),'1'=>L('PUBLIC_BOTTOM_NAVIGATION'),'2'=>L('PUBLIC_INTERNAL_APPLICATION'));
   ...
   /**
	...
	public function lang() {
		...
		// 对比语言文件
		$this->pageButton[] = array('title'=>'在线更新', 'onclick'=>"admin.compareLangFile(0)");
	...
	public function compareLangFile(){
		...
		$this->pageKeyList = array('key', 'appname', 'filetype', 'zh-cn', 'en', 'zh-tw', 'DOACTION');
		$this->pageButton[] = array('title'=>'同步','onclick'=>"admin.updateLang(this)");
		$this->_listpk = 'lang_id';	
